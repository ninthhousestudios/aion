...
const devExpressionData = ChartExpression(
  planets: [
    ...
    Planet(id: 'mercury', name: 'Mercury', longitude: 120.0, sign: 'Leo', signIndex: 4, degreeInSign: 0.0, retrograde: false, nakshatra: 'Magha', nakshatraPada: 1, house: 1),
    Planet(id: 'jupiter', name: 'Jupiter', longitude: 280.0, sign: 'Capricorn', signIndex: 9, degreeInSign: 10.0, retrograde: false, nakshatra: 'Shravana', nakshatraPada: 2, house: 6),
    Planet(id: 'venus', name: 'Venus', longitude: 160.0, sign: 'Virgo', signIndex: 5, degreeInSign: 10.0, retrograde: false, nakshatra: 'Hasta', nakshatraPada: 1, house: 2),
    Planet(id: 'saturn', name: 'Saturn', longitude: 330.0, sign: 'Pisces', signIndex: 11, degreeInSign: 0.0, retrograde: true, nakshatra: 'Purva Bhadrapada', nakshatraPada: 4, house: 8),
    Planet(id: 'rahu', name: 'Rahu', longitude: 70.0, sign: 'Gemini', signIndex: 2, degreeInSign: 10.0, retrograde: true, nakshatra: 'Ardra', nakshatraPada: 1, house: 11),
    Planet(id: 'ketu', name: 'Ketu', longitude: 250.0, sign: 'Sagittarius', signIndex: 8, degreeInSign: 10.0, retrograde: true, nakshatra: 'Moola', nakshatraPada: 1, house: 5),
  ],
